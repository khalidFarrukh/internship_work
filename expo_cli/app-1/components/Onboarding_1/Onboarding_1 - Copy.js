  ...
  return (
    <SafeAreaView style={{ flex: 1 }}>
      <View style={styles.container}>
        ...
        <S_n_button route_name={route} navigation={navigation} position={"absolute"} value={"Skip"} fontcolor={"white"} fontfamily={Poppins_Medium} op={0.5} top={"91%"} left={"8%"} fontsize={18} />
        <S_n_button route_name={route} navigation={navigation} position={"absolute"} value={"Next"} fontcolor={"white"} fontfamily={Poppins_Medium} top={"91%"} left={"82%"} fontsize={18} />
